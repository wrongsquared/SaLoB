...
public class FoodSeeder {
	...
	public List<Food> seed() {
		...
		List.of("Chicken Rice", "Hokkien Mee", "Char Kway Teow", "Laksa", "Nasi Lemak", "Roti Prata", "Satay",
				"Beef Rendang", "Chili Crab", "Popiah", "Bak Kut Teh", "Mee Goreng", "Prawn Noodle", "Fish Soup",
				"Biryani", "Ramen", "Sushi", "Tacos", "Burgers", "Pasta", "Paella", "Ceviche", "Falafel", "Quiche",
				"Dim Sum", "Peking Duck", "Kway Teow", "Oyster Omelette", "Gado Gado", "Fried Chicken", "Chow Mein",
				"Mango Sticky Rice", "Kimchi", "Curry Laksa", "Spaghetti Bolognese", "Tiramisu", "Chocolate Cake",
				"Apple Pie", "Crepes", "Shakshuka", "Thai Green Curry", "Banh Mi", "Pho", "Baba Ganoush", "Bratwurst",
				"Samosas", "Chowder", "Jambalaya", "Buffalo Wings", "Eggs Benedict", "Caesar Salad", "Gelato",
				"Pavlova", "Baklava", "Donuts", "Croissants", "Bagels", "Fettuccine Alfredo", "Coconut Curry",
				"Moussaka", "Risotto", "Tandoori Chicken").forEach(foodLabel -> {
					...
					if (!minioStorageService.objectExists(imgObjKey)) {
						if (!seedImageHelper.isImageOnDisk(imgPathOnDisk)) {
							throw new IllegalStateException("Missing food seed image at " + imgPathOnDisk
