...
public class SeedImageHelper {
	...
	/**
	 * Input: "Chicken Rice" Output: "chicken_rice.jpg"
	 */
	...
	/**
	 * Input: prefix="food-images", fileName="chicken_rice.jpg" Output:
	 * "food-images/chicken_rice.jpg"
	 */
	...
	/**
	 * Input: prefix="eatery-images", fileName="maxwell_food_centre.jpg" Output:
	 * "src/main/resources/static/eatery-images/maxwell_food_centre.jpg"
	 */
	...
	/**
	 * Input: BufferedImage + disk path Output: true when written as jpg, false
	 * otherwise.
	 */
