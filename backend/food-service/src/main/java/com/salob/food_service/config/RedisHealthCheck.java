...
/**
 * Validates Redis connectivity at application startup with detailed
 * diagnostics.
 *
 * Why this matters: - Redis connection pool doesn't fail fast by default - App
 * starts fine even if Redis is down (lazy initialization) - First actual cache
 * operation fails with unclear error - This component ensures we know
