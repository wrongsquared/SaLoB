 ...
 *            correct. (Is included within the 'benchmarkDateEntries' array)
 * @param eateryId
 ...
 *            - Dates that contain food entries for this food + eatery
 * @param benchmarkDateEntries
...
public record FoodEntryHistoricalDTO(String foodName, int sgCentsConsensusPrice, UUID eateryId, String eateryAddress,
		String submitterUsername, List<LocalDate> availableDates, List<FoodEntryPreviewDTO> benchmarkDateEntries,
