 ...
 *
 * Replaces deprecated Jackson2JsonRedisSerializer. Handles
 * serialization/deserialization of generic types like List<EateryMapDto>.
 */
@Slf4j
public class JacksonRedisSerializer implements RedisSerializer<Object> {
	...
	public byte[] serialize(Object source) {
		...
		try {
			...
			log.error("[JacksonRedisSerializer.serialize] FAILED to serialize object of type: {}",
	...
	public Object deserialize(byte[] source) {
		...
		try {
			...
			log.debug("[JacksonRedisSerializer.deserialize] Successfully deserialized to type: {}",
