 ...
 * This allows us to cache Java objects (records, lists) by serializing them to
 * JSON.
 */
@Configuration
@EnableCaching
...
public class RedisConfig {
	 ...
	 *
	 * Why this approach? - Uses custom JacksonRedisSerializer (avoids deprecated
	 * classes) - ObjectMapper with polymorphic type handling for generic types
	 * (List<EateryMapDto>) - Serializes/deserializes cleanly WITH type info
	 * embedded in JSON - Handles cache hits and misses correctly
	 */
	@Bean
